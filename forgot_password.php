                                ...
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">Entrez simplement votre adresse e-mail ci-dessous
                                             pour une verification puis vous allez réinitialiser votre mot de passe!</p>
                                    </div>
                                    <form class="user" action="verif_mail.php" name="myForm" method ="POST" onsubmit="return validateForm()">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Entrer  votre  addresse email..." name="email_">
                                        </div>
