        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php 
                        include"connect.php"; 
                        $query_pag_data = "SELECT * from publications";
                        $result_pag_data = mysqli_query($conn, $query_pag_data);
                        $pub_num = mysqli_num_rows($result_pag_data);       

                        $query_pag_data1 = "SELECT * from utilisateurs";
                        $result_pag_data1 = mysqli_query($conn, $query_pag_data1);
                        $users_num = mysqli_num_rows($result_pag_data1);
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-1">
                                                ...
                                                <div class="h3 mb-0 font-weight-bold text-gray-800"><?php echo $users_num; ?></div>
                                            </div>
                                            <div class="col-auto">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-md font-weight-bold text-success text-uppercase mb-1">
                                                    Nombres de publications</div>
                                                <div class="h3 mb-0 font-weight-bold text-gray-800"><?php echo $pub_num; ?></div>
                                            </div>
                                            <div class="col-auto">
